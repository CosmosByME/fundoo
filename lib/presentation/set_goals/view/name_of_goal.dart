        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(context.l10n.goalBody, style: TextStyle(color: Colors.grey)),
              const SizedBox(height: 30),
              Wrap(
                children: [
                  RecommendedGoalNames(
                    text: "🚗 Avtomobil",
              ...
              CustomTextField(
                controller: _goalNameController,
                label: context.l10n.writeGoal,
                maxLength: 60,
                maxLines: 3,
              ),
              const SizedBox(height: 35),
              CustomButton(
                onPressed: _goalNameController.text.isNotEmpty
                    ? () {
                        context.read<SetGoalBloc>().add(
                          SetGoalNameChanged(_goalNameController.text),
                        );
                        context.pushNamed('cost-of-goal');
                      }
                    : null,
